...
import static com.techupstudio.DataStructures.*;
import static com.techupstudio.MyFuncs.*;

public class Main {

//    public void engine(StatsArray array){
//
//        String option = inputStr("Enter an option");
//        while(true) {
//            switch (option) {
//
//                case "new":
//                    String num = inputStr("default");
//                    while (num != "q") {
//                        array.append(toInteger(num));
//                    }
//                case "sum":
//                    println(array.getSum());
//                    break;
//                case "sort":
//                    println(array.getSortedArray());
//                    break;
//                case "mean":
//                    println(array.getMean());
//                    break;
//                case "quit":
//                    break;
//
...
//        Learner.IOStreams x = new Learner.IOStreams();
//
//        x.make();
//
//        x.input();
...
//
//        println(o); println(m);
//        println(n.join(m));//used to add (append) lists object or Mylist object to content of Mylist
//        println(n.join(o));
//
//        println(n);
//
...
//        BinaryTree m = new BinaryTree(12);
//        m.add(randint(20)); m.add(randint(20));
//        m.add(randint(20)); m.add(randint(20));
//        m.add(randint(20)); m.add(randint(20));
//        m.add(randint(20)); m.add(randint(20));
//        m.add(randint(20)); m.add(randint(20));
//        m.add(15);m.add(15);m.add(15);m.add(15);m.add(15);
//
//        m.printSorted();
//
//        println();
//        for (Node i : m.toArray()){
//            print(i);
//        }
//        println();
//
...
//        fm.exploreFile("Testing").newFolder("SmallTest").exploreFile("SmallTest");
//        println(fm.goBack().goBack().getCurrentPath());


//        println(fm.goForward().getCurrentPath());

//        println(fm.newFile("data.txt").openReadWritableFile("data.txt").getAbsoluteFilePath());
